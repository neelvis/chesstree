...
- если после хода остаются ровно два активных игрока и на доске находятся либо
  ...
  игроков, партия сразу заканчивается ничьей между ними: оба делят первое место,
  а ранее выбывший игрок остаётся третьим. Это правило применяется после
  проверки вызванных ходом матов и патов.
